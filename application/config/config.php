...
define('SERVER_PUBIP', '200.13.250.19');
define('SERVER_PUBDOM', 'midominio.com');
define('SERVER_10', '10.100.88.2');

$serverActual = $_SERVER['SERVER_NAME'];
$portActual = $_SERVER['SERVER_PORT'];
$folder = 'autogestionterreno';
...
switch ($serverActual) {
    ...
    default:
		if ($portActual == 443) {
			$config['base_url'] = "https://$serverActual/$folder/";
		} else {
			$config['base_url'] = "http://$serverActual/$folder/";
		}
        break;
}
