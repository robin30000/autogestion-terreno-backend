...
class Concontingencia extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model('ModeloConsultasGestion');
	...
	public function postcontingencia()
	{
		...
		if (stripos($pedido, 'sa') !== false) {
			...
			if (!$datasoportegpon) {
				...
				$datos = $this->ModeloConsultasGestion->getDataTareaSA($pedido);
		...
		} elseif (stripos($pedido, 'w') !== false || $click === 'inactiva') {
